                        ...
                        <div className="list">
                            <div className="first_mark">
                                <div className="mark_titles">
                                    ...
                                    <p className="mark_title">
                                        Выберете возраст ребенка
                                    </p>
                                </div>
                                <div className="row">
                                    <div className="row_item">
                                        <p className="row_item_text">
                                            0-6 месяцев
                                        </p>
                                    </div>
                                    <div className="row_item">
                    ...
                    <div className="cont">
                        ...
                        <div className="positions">
                            <div className="help_row">
                                <div className="adaptive_row">
                                    <h1>Все позиции</h1>
                                    <a href="" className="filters_link">
                                        Фильтры
                                    </a>
                                </div>
                            ...
                            <div className="slider">
                                ...
                                <div className="slider_point slider_dots">
                                    ...
                                </div>
                            </div>
                        </div>
